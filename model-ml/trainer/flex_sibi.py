...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model_param_decision',
        help = 'Whether to return a one-vs-rest (‘ovr’) decision function of shape (n_samples, n_classes) as all other classifiers, or the original one-vs-one (‘ovo’) decision function of libsvm',
        choices=['ovr', 'ovo'],
        type = str,
        default = 'ovr'
    )
    ...
    model_params['decision_function_shape'] = arguments['model_param_decision']
